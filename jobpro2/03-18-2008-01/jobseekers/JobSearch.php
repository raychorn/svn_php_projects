...
<br><br>
<form action=JobSearch3.php method=post  style="background:none;">
<table align = center width="446" bgcolor="#FFFFFF">
<tr>
	<td colspan=2 align=center><b> Search for a job </b></td>
</tr>
...
<tr>
	...
	<td>
	<select name=country  style="width:290">
...
<tr>
	<td valign=top><b>Job Category: </b><br> 
	</td>

	<td valign=top>
	<SELECT NAME="JobCategory" size="1" style="width:290">
...
<tr>
	<td><b>Job's Target: </b></td>

	<td>
	<select name="careerlevel" style="width:290">
...
<tr>
	...
	<td><input type=radio name=sm value=or>or &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>
	...
	<input type=submit name=submit value=Search style="border-color:black; background-color:#e0e7e9; font-family:arial; font-weight:bold; color:#000000">
<br><br>
<font size=1 face=verdana> *If you leave blank some fields, they will not take part in the LHR Jobs search process.</font>
	</td>
</tr>
</table>
</form>
