...
<table width=446 align=center cellpadding=0 bgcolor="#FFFFFF">
...
<td valign=top>
	...
	<table width=100%  cellspacing=0  bordercolor=black>		
		<tr>
		<td>
		<b>Name:</b>
		</td>
...
<td valign=top><br>
	...
	<table width=100%  cellpadding=0 cellspacing=0  bordercolor=black>
...
<br>
	...
	<table align=center width=100% border = 0 bordercolor=black  cellspacing=0>
<tr>
...
while ($a1 = mysql_fetch_array($r2))
{
	...
	<table align=center width=446  bordercolor=black cellspacing=0 cellpadding=0>
	<caption>
...
$aaa = stripslashes($a4[SK_d]);
	...
	echo "
	<table align=center width=446  bordercolor=black cellspacing=0>
