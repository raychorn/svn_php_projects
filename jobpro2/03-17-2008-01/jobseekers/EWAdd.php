...
<form method=post action=EWAdd2.php   name=form onSubmit="return checkFields();"  style="background:none;">
...
<br>
<br>
    <input type=submit name=submit2 value="Save changes and add another">
    <input type=hidden name=WEn2 value=<?=$WEn?>>	</td>
